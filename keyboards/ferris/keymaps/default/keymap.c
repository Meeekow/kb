...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_UTL] = LAYOUT_split_3x5_2(
      CTL_R  , CTL_W  , TAB_BCK, TAB_FWD, MS_BTN1,      KC_HOME, KC_PGDN, KC_PGUP, KC_END , KC_DEL ,
      KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_ESC ,      KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, CTL_F  ,
      CTL_Z  , CTL_A  , CTL_C  , CTL_V  , MS_WHLD,      CTL_I  , CTL_BS , KC_BSPC, KC_TAB , CW_TOGG,
      PANIC, CTSFA, KC_ENT, SL_NUM),

  [_SYM] = LAYOUT_split_3x5_2(
      KC_AT  , KC_LPRN, KC_RPRN, KC_UNDS, KC_DLR ,      KC_PIPE, KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC,
      KC_EXLM, KC_DQUO, KC_MINS, KC_COLN, KC_QUES,      KC_AMPR, KC_EQL , KC_LSFT, KC_RABK, KC_LABK,
      KC_PERC, KC_ASTR, KC_PLUS, KC_SLSH, KC_TILD,      KC_CIRC, KC_HASH, KC_BSLS, KC_BSLS, IMPT   ,

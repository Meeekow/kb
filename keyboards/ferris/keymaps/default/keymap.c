...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT_split_3x5_2(
      KC_DQUO, KC_LPRN, KC_RPRN, KC_UNDS, KC_DLR ,      KC_PIPE, KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC,
      KC_EXLM, KC_MINS, KC_EQL , KC_COLN, KC_QUES,      KC_AMPR, KC_RABK, KC_LSFT, KC_LABK, KC_AT  ,
      KC_PERC, KC_ASTR, KC_PLUS, KC_SLSH, KC_TILD,      KC_CIRC, KC_HASH, KC_BSLS, KC_BSLS, KC_BSLS,

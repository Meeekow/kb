...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_UTL] = LAYOUT_split_3x5_2(
      CTL_R  , CTL_W  , TAB_BCK, TAB_FWD, CTL_L ,        KC_HOME, KC_PGDN, KC_PGUP, KC_END , KC_DEL,
   ...
   [_SYM] = LAYOUT_split_3x5_2(
      KC_LCBR, KC_LPRN, KC_RPRN, KC_RCBR, KC_PIPE,       KC_CIRC, KC_QUES, KC_LBRC, KC_RBRC, KC_AT  ,
      KC_TILD, KC_COLN, KC_MINS, KC_DQUO, KC_SCLN,       KC_LABK, KC_UNDS, KC_LSFT, KC_DLR , KC_RABK,
      KC_SLSH, KC_PLUS, KC_ASTR, KC_EQL , KC_AMPR,       KC_PERC, KC_EXLM, KC_HASH, KC_BSLS, PANIC  ,
